window.onload = function () {
  ...
  const imagenInicio=document.createElement("picture");
  ...
  imagenInicio.appendChild(img_600);
  imagenInicio.appendChild(img_400);
  imgNoCompatible.src = categoriaActual[0].imagen_img;
  imgNoCompatible.alt = categoriaActual[0].alt;
  //imgNoCompatible.width=categoriaActual[0].img_width;
  //imgNoCompatible.height=categoriaActual[0].img_height;
  imgNoCompatible.className = "imagen-inicio";
  
  imagenInicio.appendChild(imgNoCompatible);
  divImagenInicio.appendChild(imagenInicio);
  ...
  imagenLibro.width="373";
  imagenLibro.height="563";
  imagenLibro.className="portada";
  document.getElementsByClassName("detalle-libro")[0].insertBefore(imagenLibro, document.getElementById("texto-libro"));
  ...
  const divImagenRefLibro=document.getElementById("imagen-ref-libro");
  const imagenRefLibro = document.createElement("picture");
  const imgNoCompatibleRefLibro = document.createElement("img");
  ...
  img_400Ref.media = "(min-width: 240px)";
  img_400Ref.srcset = libro[0].imagen_400;
  img_400Ref.className = "imagen-ref-libro";

  imagenRefLibro.appendChild(img_800Ref);
  imagenRefLibro.appendChild(img_600Ref);
  imagenRefLibro.appendChild(img_400Ref);

  imgNoCompatibleRefLibro.src = libro[0].imagen_img;
  imgNoCompatibleRefLibro.alt = libro[0].alt;
  imgNoCompatibleRefLibro.width=libro[0].img_width;
  imgNoCompatibleRefLibro.height=libro[0].img_height;
  imgNoCompatibleRefLibro.className = "imagen-ref-libro";

  imagenRefLibro.appendChild(imgNoCompatibleRefLibro);
  divImagenRefLibro.appendChild(imagenRefLibro);
